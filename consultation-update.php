...
$Consultation_ID = $_GET['updateid']; // Use the correct variable name for Help_ID
...
if (isset($_POST['submit'])) {
    ...
    $sql = "UPDATE Consultation
            SET Status = '$status'
            WHERE Consultation_ID = '$Consultation_ID'"; // Make sure you're using the correct Help_ID variable
    ...
    if (mysqli_query($conn, $sql)) {
        header("Location: Customersupport-consultations.php"); // Redirect to the dashboard
    ...
    $sql = "SELECT * FROM Consultation WHERE Consultation_ID = '$Consultation_ID'";
...
<form action="" method="post">
    ...
    <select name="status" style="width:100px; height:30px; border:none; border-radius:10px;" id="Solved_<?php echo $row["Consultation_ID"]; ?>">
