...
if (isset($_POST['buy'])) {
    ...
    $sql = "SELECT * FROM Inventory WHERE `Name`= 'Joggers' AND `Colour` = '$color' AND `Size` = '$size' AND `Type` = '$material'"; //product ID
...
<main>
    ...
    <div class="container-2">
        <div class="form-box">
            ...
            $findPrice = "SELECT * FROM Inventory WHERE `Name`= 'Joggers'"; //product ID
