            ...
            <div class="product-images">
                ...
                <div class="product-options">
                    ...
                    <div>
                        ...
                        <input style="width: 300px;height: 45px;text-align: center;font-size: 1.2em;border: 2px solid #ff5e00;border-radius: 10px;" id="price" value="<?php echo $tanktop_price; ?>" aria-label="price" readonly>
                    </div>
